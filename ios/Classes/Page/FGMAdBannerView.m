...
//
//@interface FGMAdBannerView()<FlutterPlatformView,BUBannerAdDelegate>
//@property (strong,nonatomic) BUBannerAd *bad;
...
//    self.bad=[[BUBannerAd alloc] initWithAdUnitID:self.posId rootViewController:self.rootController adSize:CGSizeMake(width, height)];
